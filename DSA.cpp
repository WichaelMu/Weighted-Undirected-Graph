...
int main() {
	...
	// cout << "The vertices in the graph:\n";
	...
	string DFSStart = "B";
	cout << "The visiting order of DFS (starting from " + DFSStart + "):";
	for (string x : g.depth_first_traversal(DFSStart)) {
		cout << " " << x;
	}
	cout << endl;

	string BFSStart = "B";
	cout << "The visiting order of BFS (starting from " + BFSStart + "):";
	for (string x : g.breadth_first_traversal(BFSStart)) {
		cout << " " << x;
	}
	cout << endl;
